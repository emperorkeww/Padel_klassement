...
describe("Dashboard: queries bij mount (#736)", () => {
  ...
  it("vuurt precies de verwachte set queries af", async () => {
    ...
    expect(per).toEqual({
      ...
      player_standings: 1,
      player_ratings: 1,
      rating_history: 1, // de eigen grafiek
      // De gedeelde historie (avondkaart) loopt sinds #731 via een RPC met een
      // venster per speler i.p.v. een select op de hele tabel.
