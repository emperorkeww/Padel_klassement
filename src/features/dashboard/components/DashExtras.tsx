...
// Overige gamification (#276): weekmissies, badge-voortgang en rivaal —
// bereikbaar, maar niet concurrerend met de kern.
//
// De <details> eromheen zat tot #911 hier; die is naar Dashboard.tsx verhuisd
// zodat statsrij en rating in dezelfde inklapper passen. Eén inklapper voor het
// hele cijfer-blok leest rustiger dan een losse kaart met een inklapper eronder.
