...
export const SNEER: Record<RoastIntensiteit, readonly string[]> = {
  ...
  gemeen: [
    ...
    "Ik knew het niet dat we vandaag badminton aan het spelen waren. Wat een vreemde lobs.",
    ...
    "Gelukkig is de tredje helft traditioneel jouw sterkste set.",
    ...
    "Dit spel had the tactische scherpte van een natte krant in de droger.",
  ...
  radioactief: [
    ...
    "Mijn notitieboekje is uit pure frustratie uit m'n hands gesprongen en ligt nu in de vuilnisbak.",
