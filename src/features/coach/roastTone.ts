...
export const SNEER: Record<RoastIntensiteit, readonly string[]> = {
  mild: [
    ...
    "Je tactiek was vandaag as een persconferentie zonder geluid: niemand snapte er iets van.",
  ...
  gemeen: [
    ...
    "Je speelde alsof je racket een koekenpan was waar de pannenkoeken steeds uitvlegen.",
