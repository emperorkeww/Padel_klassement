...
export function KaartShowcase() {
  ...
  return (
    <main className="kaart-showcase">
      ...
      {/* Overlay-bewijs: dezelfde editie op vier schildvormen, plus de
          langste reeksregel. De crest moet op élke bovenrand sluiten (vlak,
          notch, punt, kroon, troon) en de vinnen hangen aan de gedeelde
          onderkant. */}
