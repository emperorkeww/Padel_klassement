    ...
    <svg width="0" height="0" className="fut-kaart__defs" aria-hidden="true">
      <defs>
        ...
        <clipPath id="fut-schild-piet" clipPathUnits="objectBoundingBox">
          <path d="M 0.0000 0.1274 L 0.0306 0.1127 L 0.0688 0.0971 L 0.1197 0.0770 L 0.1707 0.0605 L 0.2217 0.0467 L 0.2726 0.0348 L 0.3236 0.0247 L 0.3745 0.0156 L 0.4255 0.0082 L 0.4764 0.0037 L 0.4994 0.0018 L 0.5236 0.0037 L 0.5745 0.0082 L 0.6255 0.0156 L 0.6764 0.0247 L 0.7274 0.0348 L 0.7783 0.0467 L 0.8293 0.0605 L 0.8803 0.0770 L 0.9312 0.0971 L 0.9694 0.1127 L 1.0000 0.1274 L 1 0.6 L 1 0.8 C 1 0.8900 0.9450 0.9330 0.8600 0.9540 C 0.7300 0.9840 0.6000 0.9960 0.5000 1 C 0.4000 0.9960 0.2700 0.9840 0.1400 0.9540 C 0.0550 0.9330 0 0.8900 0 0.8 Z" />
        </clipPath>
