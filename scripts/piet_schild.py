...
ONDER = (
    f"L 1 {ONDER_V} "
    "C 1 0.8900 0.9450 0.9330 0.8600 0.9540 "
    "C 0.7300 0.9840 0.6000 0.9960 0.5000 1 "
    "C 0.4000 0.9960 0.2700 0.9840 0.1400 0.9540 "
    "C 0.0550 0.9330 0 0.8900 0 " + f"{ONDER_V}"
)
...
def _onder_beziers() -> list[tuple]:
    ...
    return [
        ((1.0, ONDER_V), (1.0, 0.89), (0.945, 0.933), (0.86, 0.954)),
        ((0.86, 0.954), (0.73, 0.984), (0.60, 0.996), (0.50, 1.0)),
        ((0.50, 1.0), (0.40, 0.996), (0.27, 0.984), (0.14, 0.954)),
        ((0.14, 0.954), (0.055, 0.933), (0.0, 0.89), (0.0, ONDER_V)),
    ]
