// Americano-rotatie voor het automatisch klaarzetten van rondes (#827):
// partners en tegenstanders wisselen zo veel mogelijk over de rondes van één
// speeldag heen.
//
// Getrouwe spiegel van src/features/groups/americano.ts — Deno en src/ kunnen
// niet uit elkaars boom importeren, net als bij clubEpoch. Weggelaten is alleen
// historyFromMatches: de cron genereert een verse reeks (er staat per definitie
// nog niets voor die dag), dus de historie begint leeg en groeit per ronde mee.
// americano.test.ts vergelijkt beide implementaties direct met dezelfde rng,
