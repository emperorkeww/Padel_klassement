...
export const PIAS_SNEER: Record<RoastIntensiteit, readonly string[]> = {
  ...
  radioactief: [
    ...
    "Dit zet ik in de groepschat. Voor de eeuwigheid, met foto en rode cirkels eromheen.",
    "Je was de favoriet vooraf, maar op de kooi gedroeg je je als een verdwaalde toerist.",
    "Zo'n winkans verprutsen is bijna een kunstvorm. Ik eis een onafhankelijk onderzoek.",
    "Choke van het seizoen! Je Elo ligt inmiddels te creperen in de afgrond.",
    "Je rating was nep. Vandaag is het masker er definitief afgerukt.",
    "De favoriet die veranderde in een wandelend tactisch drama. Mijn boekje weigert dit te registreren.",
    "Zo'n gigantische winkans weggooien is bijna crimineel. Ik ga een motie van wantrouwen indienen bij de club.",
    "Als pias van de week verdien je een permanente schandpaal met felle en knipperende neonverlichting.",
    "Je rating was blijkbaar een grote leugen. Vandaag is de kille, harde realiteit keihard binnengekomen.",
    "Ik heb het drie keer teruggekeken en elke afzonderlijke keer was het nog pijnlijker dan de vorige.",
],
};
...
export const BAGEL_SNEER: Record<RoastIntensiteit, readonly string[]> = {
  ...
  radioactief: [
    ...
    "Een droge 6-0. We eisen dat dit resultaat direct uit de geschiedenisboeken wordt gewist.",
    "Nul games gepakt. Zelfs m'n chique trainingspak weigert nog naast jouw tas te liggen.",
    "Een bagel gekregen. Zelfs de spinnen in de kelder kropen weg uit pure plaatsvervangende schaamte.",
    "0-6 afgedroogd. We gaan Infantino bellen om deze wanvertoning ongeldig te verklaren.",
    "0-6 verloren. Zelfs m'n chique trainingspak weigert vanaf vandaag nog in dezelfde tas te liggen.",
    "Een droge bagel. Ik stel voor dat we je racket direct ceremonieel verbranden op de parkeerplaats.",
    "Nul games gepakt. De glazen wanden weigeren vanaf nu nog ballen van jou fatsoenlijk te weerkaatsen.",
    "6-0 tegen. Een historische vernedering die we over tien jaar nog steeds met sadistisch genoegen bespreken.",
    "Geen enkele game gewonnen. Zelfs de kantinejuffrouw vroeg meewarig of je de regels van de sport wel kent.",
],
};
...
export const MONSTER_SNEER: Record<RoastIntensiteit, readonly string[]> = {
  ...
  radioactief: [
    ...
    "Een slachting van historisch niveau. De persconferentie wordt een regelrechte ramp.",
    "Volledig weggespeeld. Zelfs de watersproeiers weigeren water aan jullie te verspillen.",
    "Afgedroogd tot op het bot. Ik noteer dit onder het hoofdstuk 'volledige capitulatie'.",
    "Monsterlijke nederlaag. Ik overweeg serieus je racket te schenken aan het grofvuil.",
    "Gedecimeerd in de kooi. We overwegen een levenslang verbod op veld 1 voor jou.",
    "Compleet gedecimeerd. De tegenstander hoefde vandaag niet eens warm te lopen voor hun overwinning.",
    "Een slachting van ongekende proporties. Het leek op het veld wel een trainingspartijtje tegen een stel pionnen.",
    "Weggespeeld tot op het bot. Ik heb m'n spiekbriefjes spontaan in de dichtstbijzijnde prullenbak gegooid.",
    "Monsterzege tegen. Dit tactische drama schrijf ik met een hele dikke, rode stift in m'n notitieboekje.",
    "Genadeloos ingemaakt. Zelfs de watersproeiers sproeiden vandaag op veld 1 met puur medelijden.",
],
};
...
export const NIEUWE_MATCH: Record<RoastIntensiteit, readonly string[]> = {
  ...
  radioactief: [
    ...
    "Nieuwe ronde. Begin vast met een creatief excuus te schrijven, je zult het nodig hebben.",
    "Er staat een match klaar. Ik heb de lijkwagen alvast stand-by gezet voor de zekerheid.",
    "Nieuwe match. Probeer deze keer de bal wél over het net te krijgen, als experiment.",
    "Je volgende tegenstander staat klaar en ze lachen je nu al keihard uit.",
    "Nieuwe partij. M'n rode pen ligt al klaar om je rating verder te verwoesten.",
    "Nieuwe ronde. Begin vast met een creatief excuus te verzinnen, je zult het de komende match hard nodig hebben.",
    "Er staat een match klaar. Ik heb de EHBO en de clubpsycholoog alvast stand-by gezet voor de zekerheid.",
    "Nieuwe partij. Probeer deze keer in ieder geval het racket aan de goede en stroeve kant vast te houden.",
    "Je volgende tegenstander wacht al. Ze hebben de champagne al koud gezet voor de makkelijke ratingpunten.",
    "Nieuwe match. Mijn rode pen ligt al ongeduldig te wachten op je volgende en onvermijdelijke nederlaag.",
],
};
...
export const JOUW_BEURT: Record<RoastIntensiteit, readonly string[]> = {
  ...
  radioactief: [
    ...
    "Verlies je deze, dan hoort de hele groepschat het direct van me. Geen genade.",
    "Laatste kans om m'n tactische plannen niet volledig in de prullenbak te gooien.",
    "De persconferentie schrijf ik nu al. Kies zelf de toon: schaamte of diepe schaamte.",
    "Kom opdagen. Of niet — dan win ik tenminste de weddenschap met mezelf.",
    "Tijd voor de waarheid. Zelfs Trump kan een nederlaag vandaag niet meer rechtspinnen.",
    "Verlies je deze match, dan word je direct verbannen naar de tribune van veld 4 voor de rest van de maand.",
    "Laatste kans om te bewijzen dat je thuishoort in de kooi en niet permanent in de kantine met een biertje.",
    "De persconferentie na afloop is al voorbereid. Zorg dat ik m'n geschreven excuses niet live hoef op te lezen.",
    "Stap de kooi in. Of niet — dan besparen we in ieder geval de toeschouwers langs de lijn een hoop pijn.",
    "Tijd voor de kooi. Geen alibi's meer over de wind of de ballen, gewoon een keer fatsoenlijk die bal raken.",
],
};
...
> = {
  troon_kwijt: {
    ...
    "Onttroond. Ik zet 'm in de groepschat met een hele grote, rode pijl.",
    "Koppositie kwijt! We gaan de bond bellen voor een corruptie-onderzoek. Rigged!",
    "Niet langer nummer één. Mijn legendarische notitieboekje is spontaan in brand gevlogen.",
    "Troon verloren. Een Trumpiaans drama van kosmische en uiterst trieste proporties.",
    "Koppositie verloren! Van de troon gekieperd alsof je een volstrekt overbodige en trage pion was.",
    "Onttroond. Jouw koninkrijk heeft wel erg kort geduurd. Pijnlijk om aan te zien vanaf de zijlijn.",
    "Niet langer nummer één. De haaien van de club hebben je Elo-bloed geroken en direct genadeloos toegeslagen.",
    "Troon kwijt. Ik noteer deze vrije val met een hele zware en diepe zucht in m'n legendarische boekje.",
    "Koploperstatus verloren. De kroon ligt in de modder en de rest van de competitie lacht je nu al uit.",
],
  },
  uit_top3: {
    mild: [
    ...
    "Uit de top-3 geknikkerd. Van een gevaarlijke jager naar een uiterst makkelijke prooi in slechts één match.",
    "De subtop heeft je definitief uitgespuugd. Tijd voor een hele grondige, tactische en vooral pijnlijke zelfreflectie.",
    "Weg uit de top-3. Je zakte zo ongekend snel dat de database er bijna spontaan van crashte.",
    "Top-3 positie verloren. M'n chique sportpet staat direct drie graden minder vrolijk op m'n hoofd vandaag.",
    "Subtop kwijt. De tegenstander bedankte je hartelijk voor de makkelijke en gratis verschuiving in de stand.",
],
  },
  kelder: {
    mild: [
    ...
    "Welkom in de kelder. De spinnen hebben hier al een speciale hoek voor jouw zielige Elo gereserveerd.",
    "Hekkensluiter geworden. Zelfs de terreinknecht kijkt meewarig toe als je met je tas voorbijloopt.",
    "De bodem is bereikt. Ik adviseer je om de klim terug naar boven maar heel erg rustig aan te pakken.",
    "Kelderklasse bereikt. M'n notitieboekje noteert met dikke rode stift een historische en beschamende wanprestatie.",
    "Allerlaatste van de stand geworden. Zelfs een getrainde goudvis had vandaag nog z'n divisie behouden.",
],
  },
};
