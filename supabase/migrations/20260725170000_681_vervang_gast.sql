-- #681 (deel 2): in een match een gastdeelnemer vervangen door een andere
-- speler. Spiegel van supabase/schemas/functions/28_replace_match_player.sql;
-- zie dat bestand voor de toelichting. Kern: de match wordt naar het team van
-- het nieuwe paar verhangen (de team-rij zelf blijft ongemoeid, want teams zijn
-- gedeeld), waarna de statement-level triggers op public.matches alle afgeleide
-- data herberekenen.
