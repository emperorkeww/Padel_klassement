-- Beperk het toevoegen van spelers tot geaccepteerde vrienden.
-- Afgedwongen in de database (RPC + RLS), niet alleen in de UI.

------------------------------------------------------------------------
-- Helper: zijn twee spelers geaccepteerde vrienden? (beide richtingen)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- create_completed_match: elke speler moet jezelf of een vriend zijn
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- group_members: eigenaar kan alleen zichzelf of een vriend toevoegen
------------------------------------------------------------------------
drop policy "Eigenaar kan leden toevoegen" on public.group_members;
