-- Herstel de vriend-restrictie in create_completed_match.
-- De draws-migratie herdefinieerde de functie en liet daarbij per ongeluk de
-- are_friends()-check vallen, waardoor je weer matches met niet-vrienden kon
-- loggen (klassementvervalsing). Deze versie behoudt de draw-ondersteuning
-- én dwingt opnieuw af dat elke speler jezelf of een vriend is.
