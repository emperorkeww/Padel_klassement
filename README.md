...
*   🔥 **Gamification & Social Feed**
    ...
    *   **AI-portretten:** wie de troon of de schandpaal haalt, krijgt van zijn profielfoto een gegenereerd portret (generalissimo respectievelijk clown, via OpenAI `gpt-image-1`). Per soort uit te zetten in Instellingen → Weergave; uitgezet betekent dat de foto nooit verstuurd wordt.
*   🔔 **Notificaties & PWA**
